...
class App(QtWidgets.QWidget):
    ...
    def compute(self):
        ...
        devise_form = self.cbb_devisesFrom.currentText()
        devise_to = self.cbb_devisesTo.currentText()

        try:
           resultat = self.c.convert(montant, devise_form, devise_to)
        except currency_converter.currency_converter.RateNotFoundError:
            print("conversion doesn't work! try another devise")
        else:
    ...
    def inverser_devise(self):
        ...
        self.cbb_devisesTo.setCurrentText(devise_form)
